...
class AcervoUsuarioActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // BACK BUTTON
        findViewById<ImageView>(R.id.btnVoltarAcervo).setOnClickListener { finish() }
        ...
        // ------ ADAPTER COM CLIQUE QUE ABRE POPUP ------
        adapter = FavoritosPagedAdapter { livro ->
            abrirPopupResultados(livro)
        }
    ...
    // =============================
    // 🔥 ABRIR POPUP RESULTADOS
    // =============================
    private fun abrirPopupResultados(livro: Book) {
        ...
        intent.putExtra("situacaoEmprestimo", livro.situacaoEmprestimo)
        ...
        db.collection("livros")
            ...
            .addOnSuccessListener { result ->
                ...
                for (doc in result) {
                    ...
                    val livroId = doc.id
                    val tituloOriginal = doc.getString("Titulo") ?: ""
    ...
    private fun renderPage() {
        ...
        val slice =
            if (start in 0 until end) allBooks.subList(start, end)
            else emptyList()
