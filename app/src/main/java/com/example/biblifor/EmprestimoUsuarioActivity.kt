...
class EmprestimoUsuarioActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgChatBot = findViewById<ImageView>(R.id.lopesChatBot23)
        ...
        val imgNotificacao = findViewById<ImageView>(R.id.lopesNotificacao23)
        ...
        val imgSeta = findViewById<ImageView>(R.id.lopesSetaVoltar23)
        imgSeta.setOnClickListener {
            val navegarSeta = Intent(this, FavoritosUsuarioActivity::class.java)
            startActivity(navegarSeta)
        }

        val btnAceitar = findViewById<Button>(R.id.lopesBtnAceitar23)
        btnAceitar.setOnClickListener {
            val navegarAceitar = Intent(this, ConfirmacaoEmprestimoUsuarioActivity::class.java)
            startActivity(navegarAceitar)
        }

        val btnRecusar = findViewById<Button>(R.id.lopesBtnRecusar23)
        btnRecusar.setOnClickListener {
            val navegarRecusar = Intent(this, FavoritosUsuarioActivity::class.java)
